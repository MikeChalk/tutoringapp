                ...
                <li key={pt.id} className="flex justify-between items-center text-sm">
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${
                      pt.project.status === "ACTIVE" ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-zinc-100 text-zinc-600 dark:bg-zinc-700 dark:text-zinc-400"
