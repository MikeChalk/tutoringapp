...
export default function ClientWelcome({ greeting, subline, welcomeMode, todayStr }: ClientWelcomeProps) {
  ...
  const dismiss = useCallback(() => {
    ...
    sessionStorage.setItem("clientWelcomeShown", "true")
    sessionStorage.setItem("clientWelcomeDate", todayStr)
    document.cookie = `lastClientWelcomeDate=${today}; path=/; max-age=86400; SameSite=Lax`
    document.cookie = `lastClientGreeting=${encodeURIComponent(greeting)}; path=/; max-age=86400; SameSite=Lax`
