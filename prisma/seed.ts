...
async function main() {
  ...
  await prisma.billingRate.create({ data: { gradeLevel: "STUDY_HALL_TUTOR", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 0 } })
  ...
  const payScales = [
    ...
    // Study Hall Tutor rates (shared by tutors and supervisors)
    { tenure: "1ST_YEAR", gradeLevel: "STUDY_HALL_TUTOR", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 30 },
    { tenure: "2ND_YEAR", gradeLevel: "STUDY_HALL_TUTOR", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 32 },
    { tenure: "3RD_YEAR", gradeLevel: "STUDY_HALL_TUTOR", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 35 },
    // Supervisor category rates
    { tenure: "1ST_YEAR", gradeLevel: "IN_PERSON_MGMT", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 20 },
    { tenure: "2ND_YEAR", gradeLevel: "IN_PERSON_MGMT", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 22 },
    { tenure: "3RD_YEAR", gradeLevel: "IN_PERSON_MGMT", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 24 },
    { tenure: "1ST_YEAR", gradeLevel: "ONLINE_MGMT", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 18 },
    { tenure: "2ND_YEAR", gradeLevel: "ONLINE_MGMT", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 20 },
    { tenure: "3RD_YEAR", gradeLevel: "ONLINE_MGMT", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 22 },
    ...
    { tenure: "1ST_YEAR", gradeLevel: "MARKETING", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 18 },
    { tenure: "2ND_YEAR", gradeLevel: "MARKETING", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 20 },
    { tenure: "3RD_YEAR", gradeLevel: "MARKETING", mode: "IN_PERSON", projectType: "STUDY_HALL", rate: 22 },
  ]
